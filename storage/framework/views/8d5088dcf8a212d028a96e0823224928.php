<nav x-data="{ open: false }" class="bg-gray-800 text-white shadow fixed top-0 left-0 right-0 z-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between h-16 items-center">
      ...
      <div class="hidden sm:flex items-center space-x-10 py-2">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center space-x-2 px-3 py-2 hover:text-white hover:bg-gray-700 rounded transition">
          <i class="bi bi-house-door text-gray-300"></i>
          <span>Dashboard</span>
        </a>

        <a href="<?php echo e(route('utilisateurs')); ?>" class="flex items-center space-x-2 px-3 py-2 hover:text-white hover:bg-gray-700 rounded transition">
          <i class="bi bi-people text-gray-300"></i>
          <span>Utilisateurs</span>
        </a>

        <a href="<?php echo e(route('admin.commandes')); ?>" class="flex items-center space-x-2 px-3 py-2 hover:text-white hover:bg-gray-700 rounded transition">
          <i class="bi bi-cart text-gray-300"></i>
          <span>Commandes</span>
        </a>

        <a href="<?php echo e(route('admin.articles.index')); ?>" class="flex items-center space-x-2 px-3 py-2 hover:text-white hover:bg-gray-700 rounded transition">
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
           <?php $__env->slot('trigger', null, []); ?> 
            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
              <div><?php echo e(Auth::user()->prenom.'  ' .Auth::user()->nom); ?></div>
              <div class="ms-1">
...
<?php endif; ?>
  ...
  <div :class="open ? 'block' : 'hidden'" class="sm:hidden" id="mobile-menu">
    <div class="px-2 pt-2 pb-3 space-y-1">
      <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center px-3 py-2 text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 rounded-md">
        <i class="bi bi-house-door h-5 w-5 text-gray-300"></i>
        <span class="ms-2">Dashboard</span>
      </a>

      <a href="<?php echo e(route('utilisateurs')); ?>" class="flex items-center px-3 py-2 text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700 rounded-md">
    ...
    <div class="pt-4 pb-3 border-t border-gray-700">
      <div class="px-5 flex items-center">
        ...
        <div class="ml-3">
          <div class="text-base font-medium leading-none text-white"><?php echo e(Auth::user()->prenom.'  ' .Auth::user()->nom); ?></div>
          <div class="text-sm font-medium leading-none text-gray-400"><?php echo e(Auth::user()->email); ?></div>
        </div>
      </div>
      <div class="mt-3 px-2 space-y-1">
        <a href="<?php echo e(route('profile.edit')); ?>" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700">Profile</a>
        <form method="POST" action="<?php echo e(route('logout')); ?>">
          <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\pc\Desktop\Projet\pfe\authentification\resources\views/layouts/admin-navigation.blade.php ENDPATH**/ ?>