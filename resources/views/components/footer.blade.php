    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 py-12 border-b border-amber-800">
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="{{route('support.contact')}}" class="text-gray-300 hover:text-white text-sm">Contactez-nous</a></li>
        ...
        <div class="py-4 border-t border-amber-800 text-center">
            <p class="text-gray-400 text-xs">
                &copy; {{ date('Y') }} {{ $author }}. D2Market n'est pas affilié à Blizzard Entertainment.
            </p>
        </div>
    </div>
</footer>